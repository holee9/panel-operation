...
(
  ...
  assign afe_dout_a_bus = {{(MAX_AFE_CHIPS-1){1'b0}}, afe_dout_a_p};
  assign afe_dout_b_bus = {{(MAX_AFE_CHIPS-1){1'b0}}, afe_dout_b_p};
  assign afe_dclk_bus = {{(MAX_AFE_CHIPS-1){1'b0}}, afe_dclk_p};
